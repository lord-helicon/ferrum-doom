...
impl PVS {
    ...
    pub fn get_pvs_cache_path(
        ...
        let base = std::env::var_os("ROOM4DOOM_PVS_CACHE")
    ...
    fn build_subsector_visibility(
        ...
        // Process subsectors sequentially. This keeps wasm builds portable.
        for source_subsector_idx in 0..subsector_count {
